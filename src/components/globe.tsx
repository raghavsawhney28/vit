...
const Globe = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900 text-gray-50 p-2 sm:p-4 font-inter">
      <div className="relative w-full max-w-4xl aspect-video rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl bg-gray-800">
        {!isReady && (
          <div className="absolute inset-0 flex items-center justify-center text-gray-400 z-10">
            ...
            <span className="ml-2 sm:ml-3 text-sm sm:text-base">Loading...</span>
          </div>
        )}
        <div 
          ref={mountRef} 
      ...
      <span className="absolute cursive text-gray-700 text-sm sm:text-base" >Khyatuuu</span>
    </div>
  );
};
